...
export function ClientsPage() {
  ...
  const { data: clientsData, isLoading, error } = useClients(trimmedSearch ? { search: trimmedSearch } : undefined);
  ...
  const handleDialogOpenChange = (nextOpen: boolean) => {
    ...
    if (!nextOpen) setSelectedClient(undefined);
  };
    ...
    <MainLayout>
      <div className="space-y-6">
        ...
        <Card>
          ...
          <CardContent>
            {error ? (
              <div className="text-center py-8 text-destructive">Error loading clients</div>
            ) : clients.length > 0 ? (
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          ...
          {/* Buttons aligned right, matching the Save/Cancel pattern */}
