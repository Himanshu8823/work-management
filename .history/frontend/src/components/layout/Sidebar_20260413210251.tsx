...
export function Sidebar({ isOpen = true }: SidebarProps) {
  ...
  return (
    <aside
      className={cn(
        'fixed md:relative left-0 top-0 z-30 h-screen md:h-auto w-64 bg-gradient-to-b from-orange-100 to-orange-50 border-r border-orange-200 pt-16 md:pt-0 transition-transform duration-200 md:translate-x-0',
