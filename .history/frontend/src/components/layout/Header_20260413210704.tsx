...
export function Header({ onMobileMenuToggle }: HeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-40 bg-gradient-to-r from-blue-50 to-blue-100 border-b-2 border-blue-200 shadow-sm">
      <div className="px-4 sm:px-6 lg:px-8 flex h-16 items-center justify-between">
        {/* Mobile Menu Button */}
        <button
          onClick={onMobileMenuToggle}
          className="md:hidden p-2 rounded-lg hover:bg-blue-200 transition-colors text-gray-700"
        >
